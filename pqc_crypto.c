...
#include "../include/pqc_crypto.h"
#include "../include/pqc_log.h"
...
const char *hig_error_str(HigError err) {
  ...
  case HIG_ERR_NETWORK:
    return "network error";
  case HIG_ERR_CONSENSUS:
  ...
  case HIG_ERR_DUPLICATE:
    return "duplicate";
  case HIG_ERR_STORAGE:
    return "storage error";
  case HIG_ERR_TIMEOUT:
    return "timeout";
  case HIG_ERR_RATE_LIMITED:
    return "rate limited";
  case HIG_ERR_CIRCUIT_OPEN:
    return "circuit open";
  default:
